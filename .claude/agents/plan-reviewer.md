---
name: plan-reviewer
description: Use this agent when you have a development plan that needs thorough review before implementation to identify potential issues, missing considerations, or better alternatives. Use for authentication integrations, database migrations, API integrations, or any high-stakes architectural changes.
model: opus
color: yellow
---
